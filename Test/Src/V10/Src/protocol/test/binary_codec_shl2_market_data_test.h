...
namespace wmdf{
void TestSHL2MarketDataBinaryCodec()
	{
    cout<<"------SZSE L2 MarketData BianryCodec------"<<endl;
    clock_t start, end;
    ...
    L2MarketSnapshot* marketDatas = new L2MarketSnapshot[ilength];
      ...
      marketDatas[i].transactions_count =i*100001;
		...
		BinaryCodecSHL2MarketData* codec = new BinaryCodecSHL2MarketData();
    ...
    {*/
      ...
      std::cout<<"BufferSize:"<<bufferSize<<std::endl;
          ...
          for(int i = 0;i<count;i++)
          {
            ...
            {
              std::cout<<"BinaryCodecSHL2MarketData ["<<i<<"] error!"<<std::endl;
            }
            /*else
            {
